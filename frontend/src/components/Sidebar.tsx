...
export function Sidebar() {
  ...
  return (
    <aside className="flex w-64 flex-col border-r border-gray-200/80 bg-white">
      ...
      {/* Sign out */}
      <div className="border-t border-gray-200/80 px-3 py-4">
        <button
          onClick={handleLogout}
          className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-sm font-medium text-gray-500 hover:bg-gray-50 hover:text-gray-700"
        >
          <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
